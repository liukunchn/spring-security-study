...
//                        .accessDeniedHandler(accessDeniedHandler())
    ...
    @Bean
    public CustomCasAuthenticationEntryPoint casAuthenticationEntryPoint() {
        CustomCasAuthenticationEntryPoint casAuthenticationEntryPoint = new CustomCasAuthenticationEntryPoint(objectMapper);
...
//        casAuthenticationFilter.setAuthenticationFailureHandler();
    ...
    public CustomSimpleUrlLogoutSuccessHandler customSimpleUrlLogoutSuccessHandler() {
        ...
        CustomSimpleUrlLogoutSuccessHandler customSimpleUrlLogoutSuccessHandler = new CustomSimpleUrlLogoutSuccessHandler(service, objectMapper);
