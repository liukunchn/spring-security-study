...
import com.maoyou.security.security.jwt.JwtAuthenticationFilter;
import com.maoyou.security.security.jwt.JwtConfiguration;
...
//        return http.build();
        ...
        http
                // 添加jwt认证过滤器
                .addFilterAfter(new JwtAuthenticationFilter(jwtRepository, jwtConfiguration), UsernamePasswordAuthenticationFilter.class)
                // 配置权限
                .authorizeHttpRequests(authorize -> authorize
...
//                        .logoutSuccessUrl("/login?logout").permitAll()
                ...
                .sessionManagement(session -> session
                        // session创建策略。如果使用token，那么应该不创建session
...
//    }
    ...
    public AuthenticationSuccessHandler customAuthenticationSuccessHandler() {
        CustomAuthenticationSuccessHandler customAuthenticationSuccessHandler = new CustomAuthenticationSuccessHandler(jwtRepository, objectMapper);
    ...
    public LogoutSuccessHandler customLogoutSuccessHandler() {
        CustomLogoutSuccessHandler customLogoutSuccessHandler = new CustomLogoutSuccessHandler(jwtRepository, objectMapper);
